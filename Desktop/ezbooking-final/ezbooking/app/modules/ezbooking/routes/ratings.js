...
var mod_config = {
    module : 'ezbooking',
    resource : 'ratings',
    collection : 'ezbookingRatings',
    route : 'ezbooking/ratings',
    view : 'ratings',
    alias : 'ratings'
};

var ratings = express.Router();
ratings.get('/', async function(req, res) {
...
//Get add
ratings.get('/add', async function(req, res){
    try {
        var dataView = helpers.admin.get_data_view_admin(req,mod_config);
...
//Post add
ratings.post('/add', async function(req, res){
    try {
...
//Get edit
ratings.get('/edit/:id', async function (req, res) {
    try {
        //validate
...
//post edit
ratings.post('/edit/:id', async function (req, res) {
    try {
...
//GET import
ratings.get('/import',async function(req, res){
    try {
        var dataView = helpers.admin.get_data_view_admin(req, mod_config);
        var ignore_fields = '__v update_by createdAt updatedAt';
        dataView.fields = await moduleModel.get_fields(mod_config, ignore_fields);
 ...
 *
 */
ratings.post('/import', function(req, res){
    try {
...
//GET export
ratings.get('/export', async function(req, res){
    try {
        var fields = await moduleModel.get_fields(mod_config,'__v');
        var field_keys = Object.keys(fields);
        var dataView = helpers.admin.get_data_view_admin(req, mod_config);
...
//Export
ratings.post('/export', async function(req, res){
    try {
...
//delete
ratings.post('/delete', async function (req, res) {
    var post_data = req.body;
...
//Get detail
ratings.get('/detail/:_id', async function(req, res){
    try {
        //validate
        var validator = new helpers.validate();
