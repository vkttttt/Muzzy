...
var mod_config = {
    ...
    collection : 'ezbookingRestaurants',
    route : 'ezbooking/restaurants',
    view : 'restaurants',
    alias : 'restaurants'
};

var restaurants = express.Router();
restaurants.get('/', async function(req, res) {
...
//Get add
restaurants.get('/add', async function(req, res){
    try {
        var dataView = helpers.admin.get_data_view_admin(req,mod_config);
...
//Post add
restaurants.post('/add', async function(req, res){
    try {
...
//Get edit
restaurants.get('/edit/:id', async function (req, res) {
    try {
        //validate
...
//post edit
restaurants.post('/edit/:id', async function (req, res) {
    try {
...
//GET import
restaurants.get('/import',async function(req, res){
    try {
        var dataView = helpers.admin.get_data_view_admin(req, mod_config);
        var ignore_fields = '__v update_by createdAt updatedAt';
        dataView.fields = await moduleModel.get_fields(mod_config, ignore_fields);
 ...
 *
 */
restaurants.post('/import', function(req, res){
    try {
...
//GET export
restaurants.get('/export', async function(req, res){
    try {
        var fields = await moduleModel.get_fields(mod_config,'__v');
        var field_keys = Object.keys(fields);
        var dataView = helpers.admin.get_data_view_admin(req, mod_config);
...
//Export
restaurants.post('/export', async function(req, res){
    try {
...
//delete
restaurants.post('/delete', async function (req, res) {
    var post_data = req.body;
...
//Get detail
restaurants.get('/detail/:_id', async function(req, res){
    try {
        //validate
        var validator = new helpers.validate();
