...
var mod_config = {
    module : 'ezbooking',
    resource : 'categories',
    collection : 'ezbookingCategories',
    route : 'ezbooking/categories',
    view : 'categories',
    alias : 'categories'
};

var categories = express.Router();
categories.get('/', async function(req, res) {
...
//Get add
categories.get('/add', async function(req, res){
    try {
        var dataView = helpers.admin.get_data_view_admin(req,mod_config);
...
//Post add
categories.post('/add', async function(req, res){
    try {
...
//Get edit
categories.get('/edit/:id', async function (req, res) {
    try {
        //validate
...
//post edit
categories.post('/edit/:id', async function (req, res) {
    try {
...
//GET import
categories.get('/import',async function(req, res){
    try {
        var dataView = helpers.admin.get_data_view_admin(req, mod_config);
        var ignore_fields = '__v update_by createdAt updatedAt';
        dataView.fields = await moduleModel.get_fields(mod_config, ignore_fields);
 ...
 *
 */
categories.post('/import', function(req, res){
    try {
...
//GET export
categories.get('/export', async function(req, res){
    try {
        var fields = await moduleModel.get_fields(mod_config,'__v');
        var field_keys = Object.keys(fields);
        var dataView = helpers.admin.get_data_view_admin(req, mod_config);
...
//Export
categories.post('/export', async function(req, res){
    try {
...
//delete
categories.post('/delete', async function (req, res) {
    var post_data = req.body;
...
//Get detail
categories.get('/detail/:_id', async function(req, res){
    try {
        //validate
        var validator = new helpers.validate();
