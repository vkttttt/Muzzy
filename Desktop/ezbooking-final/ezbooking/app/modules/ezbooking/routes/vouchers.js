...
var mod_config = {
    module : 'ezbooking',
    resource : 'vouchers',
    collection : 'ezbookingVouchers',
    route : 'ezbooking/vouchers',
    view : 'vouchers',
    alias : 'vouchers'
};

var vouchers = express.Router();
vouchers.get('/', async function(req, res) {
...
//Get add
vouchers.get('/add', async function(req, res){
    try {
        var dataView = helpers.admin.get_data_view_admin(req,mod_config);
...
//Post add
vouchers.post('/add', async function(req, res){
    try {
...
//Get edit
vouchers.get('/edit/:id', async function (req, res) {
    try {
        //validate
...
//post edit
vouchers.post('/edit/:id', async function (req, res) {
    try {
...
//GET import
vouchers.get('/import',async function(req, res){
    try {
        var dataView = helpers.admin.get_data_view_admin(req, mod_config);
        var ignore_fields = '__v update_by createdAt updatedAt';
        dataView.fields = await moduleModel.get_fields(mod_config, ignore_fields);
 ...
 *
 */
vouchers.post('/import', function(req, res){
    try {
...
//GET export
vouchers.get('/export', async function(req, res){
    try {
        var fields = await moduleModel.get_fields(mod_config,'__v');
        var field_keys = Object.keys(fields);
        var dataView = helpers.admin.get_data_view_admin(req, mod_config);
...
//Export
vouchers.post('/export', async function(req, res){
    try {
...
//delete
vouchers.post('/delete', async function (req, res) {
    var post_data = req.body;
...
//Get detail
vouchers.get('/detail/:_id', async function(req, res){
    try {
        //validate
        var validator = new helpers.validate();
