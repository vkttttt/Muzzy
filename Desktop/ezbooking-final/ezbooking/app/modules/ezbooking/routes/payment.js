...
var mod_config = {
    ...
    route : 'ezbooking/payment',
    view : 'payment',
    alias : 'payment'
};

var payment = express.Router();
payment.get('/', async function(req, res) {
...
//Get add
payment.get('/add', async function(req, res){
    try {
        var dataView = helpers.admin.get_data_view_admin(req,mod_config);
...
//Post add
payment.post('/add', async function(req, res){
    try {
...
//Get edit
payment.get('/edit/:id', async function (req, res) {
    try {
        //validate
...
//post edit
payment.post('/edit/:id', async function (req, res) {
    try {
...
//GET import
payment.get('/import',async function(req, res){
    try {
        var dataView = helpers.admin.get_data_view_admin(req, mod_config);
        var ignore_fields = '__v update_by createdAt updatedAt';
        dataView.fields = await moduleModel.get_fields(mod_config, ignore_fields);
 ...
 *
 */
payment.post('/import', function(req, res){
    try {
...
//GET export
payment.get('/export', async function(req, res){
    try {
        var fields = await moduleModel.get_fields(mod_config,'__v');
        var field_keys = Object.keys(fields);
        var dataView = helpers.admin.get_data_view_admin(req, mod_config);
...
//Export
payment.post('/export', async function(req, res){
    try {
...
//delete
payment.post('/delete', async function (req, res) {
    var post_data = req.body;
...
//Get detail
payment.get('/detail/:_id', async function(req, res){
    try {
        //validate
        var validator = new helpers.validate();
