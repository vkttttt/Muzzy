...
var mod_config = {
    module : 'ezbooking',
    resource : 'gift',
    collection : 'ezbookingGifts',
    route : 'ezbooking/gift',
    view : 'gift',
    alias : 'gift'
};

var gift = express.Router();
gift.get('/', async function(req, res) {
...
//Get add
gift.get('/add', async function(req, res){
    try {
        var dataView = helpers.admin.get_data_view_admin(req,mod_config);
...
//Post add
gift.post('/add', async function(req, res){
    try {
...
//Get edit
gift.get('/edit/:id', async function (req, res) {
    try {
        //validate
...
//post edit
gift.post('/edit/:id', async function (req, res) {
    try {
...
//GET import
gift.get('/import',async function(req, res){
    try {
        var dataView = helpers.admin.get_data_view_admin(req, mod_config);
        var ignore_fields = '__v update_by createdAt updatedAt';
        dataView.fields = await moduleModel.get_fields(mod_config, ignore_fields);
 ...
 *
 */
gift.post('/import', function(req, res){
    try {
...
//GET export
gift.get('/export', async function(req, res){
    try {
        var fields = await moduleModel.get_fields(mod_config,'__v');
        var field_keys = Object.keys(fields);
        var dataView = helpers.admin.get_data_view_admin(req, mod_config);
...
//Export
gift.post('/export', async function(req, res){
    try {
...
//delete
gift.post('/delete', async function (req, res) {
    var post_data = req.body;
...
//Get detail
gift.get('/detail/:_id', async function(req, res){
    try {
        //validate
        var validator = new helpers.validate();
