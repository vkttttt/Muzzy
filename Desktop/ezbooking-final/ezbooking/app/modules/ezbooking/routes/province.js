...
var mod_config = {
    module : 'ezbooking',
    resource : 'province',
    collection : 'ezbookingProvinces',
    route : 'ezbooking/province',
    view : 'province',
    alias : 'province'
};

var province = express.Router();
province.get('/', async function(req, res) {
...
//Get add
province.get('/add', async function(req, res){
    try {
        var dataView = helpers.admin.get_data_view_admin(req,mod_config);
...
//Post add
province.post('/add', async function(req, res){
    try {
...
//Get edit
province.get('/edit/:id', async function (req, res) {
    try {
        //validate
...
//post edit
province.post('/edit/:id', async function (req, res) {
    try {
...
//GET import
province.get('/import',async function(req, res){
    try {
        var dataView = helpers.admin.get_data_view_admin(req, mod_config);
        var ignore_fields = '__v update_by createdAt updatedAt';
        dataView.fields = await moduleModel.get_fields(mod_config, ignore_fields);
 ...
 *
 */
province.post('/import', function(req, res){
    try {
...
//GET export
province.get('/export', async function(req, res){
    try {
        var fields = await moduleModel.get_fields(mod_config,'__v');
        var field_keys = Object.keys(fields);
        var dataView = helpers.admin.get_data_view_admin(req, mod_config);
...
//Export
province.post('/export', async function(req, res){
    try {
...
//delete
province.post('/delete', async function (req, res) {
    var post_data = req.body;
...
//Get detail
province.get('/detail/:_id', async function(req, res){
    try {
        //validate
        var validator = new helpers.validate();
