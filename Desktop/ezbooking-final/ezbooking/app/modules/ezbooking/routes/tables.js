...
var mod_config = {
    module : 'ezbooking',
    resource : 'tables',
    collection : 'ezbookingTables',
    route : 'ezbooking/tables',
    view : 'tables',
    alias : 'tables'
};

var tables = express.Router();
tables.get('/', async function(req, res) {
...
//Get add
tables.get('/add', async function(req, res){
    try {
        var dataView = helpers.admin.get_data_view_admin(req,mod_config);
...
//Post add
tables.post('/add', async function(req, res){
    try {
...
//Get edit
tables.get('/edit/:id', async function (req, res) {
    try {
        //validate
...
//post edit
tables.post('/edit/:id', async function (req, res) {
    try {
...
//GET import
tables.get('/import',async function(req, res){
    try {
        var dataView = helpers.admin.get_data_view_admin(req, mod_config);
        var ignore_fields = '__v update_by createdAt updatedAt';
        dataView.fields = await moduleModel.get_fields(mod_config, ignore_fields);
 ...
 *
 */
tables.post('/import', function(req, res){
    try {
...
//GET export
tables.get('/export', async function(req, res){
    try {
        var fields = await moduleModel.get_fields(mod_config,'__v');
        var field_keys = Object.keys(fields);
        var dataView = helpers.admin.get_data_view_admin(req, mod_config);
...
//Export
tables.post('/export', async function(req, res){
    try {
...
//delete
tables.post('/delete', async function (req, res) {
    var post_data = req.body;
...
//Get detail
tables.get('/detail/:_id', async function(req, res){
    try {
        //validate
        var validator = new helpers.validate();
