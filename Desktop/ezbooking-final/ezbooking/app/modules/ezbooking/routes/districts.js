...
var mod_config = {
    module : 'ezbooking',
    resource : 'districts',
    collection : 'ezbookingDistricts',
    route : 'ezbooking/districts',
    view : 'districts',
    alias : 'districts'
};

var districts = express.Router();
districts.get('/', async function(req, res) {
...
//Get add
districts.get('/add', async function(req, res){
    try {
        var dataView = helpers.admin.get_data_view_admin(req,mod_config);
...
//Post add
districts.post('/add', async function(req, res){
    try {
...
//Get edit
districts.get('/edit/:id', async function (req, res) {
    try {
        //validate
...
//post edit
districts.post('/edit/:id', async function (req, res) {
    try {
...
//GET import
districts.get('/import',async function(req, res){
    try {
        var dataView = helpers.admin.get_data_view_admin(req, mod_config);
        var ignore_fields = '__v update_by createdAt updatedAt';
        dataView.fields = await moduleModel.get_fields(mod_config, ignore_fields);
 ...
 *
 */
districts.post('/import', function(req, res){
    try {
...
//GET export
districts.get('/export', async function(req, res){
    try {
        var fields = await moduleModel.get_fields(mod_config,'__v');
        var field_keys = Object.keys(fields);
        var dataView = helpers.admin.get_data_view_admin(req, mod_config);
...
//Export
districts.post('/export', async function(req, res){
    try {
...
//delete
districts.post('/delete', async function (req, res) {
    var post_data = req.body;
...
//Get detail
districts.get('/detail/:_id', async function(req, res){
    try {
        //validate
        var validator = new helpers.validate();
